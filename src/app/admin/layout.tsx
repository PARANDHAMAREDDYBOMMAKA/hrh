...
export default function AdminLayout({
  ...
  return (
    <div className="min-h-screen flex bg-[#fafaf9]">
        ...
        <div className="p-7 pb-5">
          <Link href="/admin/dashboard" className="flex items-center gap-2.5 group">
            ...
            <div>
              ...
              <span className="block text-[10px] text-foreground/30 font-semibold tracking-widest uppercase">Admin</span>
            </div>
          </Link>
        </div>
      ...
      {sidebarOpen && (
        <div className="fixed inset-0 bg-black/20 backdrop-blur-[2px] z-40 lg:hidden" onClick={() => setSidebarOpen(false)} />
      )}
